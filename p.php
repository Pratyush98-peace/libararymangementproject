...
<html lang="en" dir="ltr">
  ...
  <body style="background-color:#7FFF00">
   ...
   <div id="left"><br><br><br>
       ...
       <h1 style="color: red;margin-left: 50px" >Romantic Books</h1>
      <?php
         $c=$_GET['id'];
       ...
       ?>
         ...
         ?><br>
        <h3 ><font color="red">Name: </font><?php echo $name ?><br><font color="red">price: </font><?php echo $price ?></h3>
       <a href="p2.php?id=<?php echo $id;?>" style="width: 300px;height:100px;padding:5px;background-color:red;border-radius:10px;">Buy Now</a>
