...
<html lang="en" dir="ltr">
  ...
  <body style="background-color:#7FFF00">
    ...
    <div id="left"><br><br><br>
       ...
       <h1 style="color: red;margin-left: 50px" >Top rated Books</h1>
       <div id="a"><center><img src="img/c.jpg"></center></div>
       <div id="c"></div>
       <div id="b"><center><img src="img/b.jpeg"></center></div>
        <div id="c"></div>
        <div id="a"><center><img src="img/a.jpg"></center></div>
